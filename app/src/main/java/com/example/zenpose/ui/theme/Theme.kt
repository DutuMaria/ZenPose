 ...
 * Aplica tema ZenPose.
 *
 * @param darkTheme – dacă vrei să forțezi manual dark/light (by default ia din sistem).
 * @param dynamicColor – pe Android 12+ ia Dynamic Color (Material You). Dacă vrei strict paleta ta, setează false.
 */
@Composable
fun ZenPoseTheme(
